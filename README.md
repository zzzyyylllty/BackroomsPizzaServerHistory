# BackroomsPizzaServerHistory

_Markdown 披萨服永乐大典_

# 前言

为解决萌新对部分材料用处不明或物品错误使用，使各位玩家游玩过程更为顺利，本书/项目从玩家角度出发。在Beta版本与txt版本基础上，著成目前的Markdown版本。披萨服永乐大典由肆九一人出品, **不得盗用**, Markdown版本由 zzzyyylll_ty 修补
...
1. 记住记住记住！重要的事情说三遍, 不足则扣除！不足则扣除！不足则扣除！玩家一定要看清楚材料才
进行合成与购买, 避免东西被吞; 
2. 当你发现屏幕上方未对某样物品进行说明（如未对物品标价）, 可查看屏幕下方快捷栏是否有小字; 
3. 按住Tab键查看积分; 
4. 服务器是Wiki版的后室服务器, 无Famdom版后室层级; 
5: 由于网易问题, 因此服务器网络问题较为突出, 腐竹与op正在极力优化中, 不便之处敬请谅解;
6: 不准刷屏, 开挂, 持有违禁品, 加入非法组织等行为, 违者严重Ban IP, 请玩家之间互相监督; 
7: 服务器通用货币为积分, 玩家间可以使用积分作为交易货币; 
8: 请不要在服务器高峰期挂机, 避免增加服务器负担挂机时需谨慎, 否则后果自负; 
9: 服务器为偏高难度服务器, 新手期较长;
10: 主线武器千万不要附魔（可能出现无法升级等现象）; 
11: 付费项目服务器内商城有详细展示, 请认准给腐竹打款, 尽量别让钱经过第三方; 
12: 定制武器详细可看群公告; 
13: 有急事可前往接待群（群公告有）进行咨询, 避免信息在主群被刷; 
14: 群内服内聊天注意素质, 可以色, 但别过头, 但不该碰的绝对不能碰; 
15: 以上便是所有注意事项啦, 大家游玩愉快, 不懂可以多多询问, 我们会尽全力帮助你awa。
```

本注意事项由肆九制作, 有意见可以提出, 我会立即改正
...
* Level 24 - “月球”
* Level 25 - “四分之一枢纽”
* Level 26 - “恍如隔世” _(wiki目前为“享乐号汽船”)_
* Lavel 27 - “岩体泉”
* Level 28 - “岚石要塞”
* Level 29 - “海波利亚”
* Level 30 - “超越现实”
...
(注: 详细可看http://backrooms-wiki-cn.wikidot.com/object-30）
...
(注: 详细可看http://backrooms-wiki-cn.wikidot.com/object-13）
...
（注: 详细可看http://backrooms-wiki-cn.wikidot.com/object-24）
...
（注: 想了解更多可来http://backrooms-wiki-cn.wikidot.com/entity-198阅读）
...
（注: 详细可看http://backrooms-wiki-cn.wikidot.com/entity-17）
...
(注: 详细可看http://backrooms-wiki-cn.wikidot.com/object-19）
...
(详见: http://backrooms-wiki-cn.wikidot.com/object-21）
...
（注: 想了解更多可来http://backrooms-wiki-cn.wikidot.com/entity-198）
...
咔嗒机为体积大小与普通打字机无异的打字机, 其底部装有轮子，且密
度极大(大干前厅中典型的打字机)，以至于其过于沉重，无法将其拾起。
咔嗒机上的按键为典型的QWERTY键盘排列方式，但如果试图用其打字，
便会出现类似古埃及象形文字的文字，阅读该文字的材料可能会导致暂时
性的昏厥和头晕。若你在后室中看到诸如此类的文字, 请联系M.E.G我们
会用目前已知所有对咔嗒机的了解来翻译该文字。
...
* 0.25 击退抗性
* 无法破坏
（注: 详见http://backrooms-wiki-cn.wikidot.com/entity-14）
材料: 4个地栖怪长肢
获取方式: Level 1 Alpha基地2楼兑换
...
* +0.03 速度
* 0.4 击退抗性
(注: 圣甲虫详见http://backrooms-wiki-cn.wikidot.com/object-14）
材料: 448积分＋1个心愿西瓜
获取方式: Level 4 Omega基地2楼商店内兑换
...
姜太公钓鱼-HK2型七彩荧光碳纤维牛皮包裹绝不空军壹号（已删除）
耐久X
海之眷顾X
饵钓 V
经验修补
...
“未来探索者实验室”「Who is Future Changer?」


疯狂机械装置

据说造型是参考电影《疯狂的麦克斯》里的某个装备。可真是够血腥的
.…副手时，需要消耗血液去驱动它!
...
Tips: 1.“机械零部件”与“机械组合结构”均为标签，无实物
        2.需解锁主线武器“蒸汽时代”
        3.“机械零部件”材料为“海波利亚之金属锭×6＋防水布×5＋铁壳×4＋元件×3”
        4.“机械组合结构”材料为“后室灭火器＋戒尺×2＋动力装置×3”

虚幻魔镜

“嘿，你们玩过VR吗?我曾天真地以为这是，直到那个人真的
抽了我一嘴巴子!”

想要拥有极致的躲闪吗?屏息凝神，蓄势待发。原地蹲下，戴
上魔镜，十六步之内，体验闪电侠的感觉!
...
Tips:1.需解锁主线武器“遗忘梦境”
        2.“神秘魔法”与“电”均为标签，无实物
        3.“神秘魔法”材料为TCG卡牌1套＋咔哒机×3
        4.“电”材料为空瓶子×9＋海波利亚之金属锭×6＋黄色电线×3＋蓝色电线5×3＋紫色电线×3
            ＋WIFI×3＋电池×1
